...
public class MainActivity extends AppCompatActivity {
        ...
        detectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    module = Module.load(fetchModelFile(MainActivity.this, "mobilenet-v2.pt"));
                } catch (IOException e) {
                    finish();
                }
                ...
                String detected_class = Constants.IMAGENET_CLASSES[ms_ix];

                //Writing the detected class in to the text view of the layout
                TextView textView = findViewById(R.id.result_text);
                textView.setText("Ảnh trên có " + detected_class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == cameraRequestCode && resultCode == RESULT_OK && checkBtn == 1){
            ...
            //Writing the detected class in to the text view of the layout
            TextView textView = findViewById(R.id.result_text);
            textView.setText("Ảnh trên có " + pred);
        }


        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data && checkBtn == 0) {
